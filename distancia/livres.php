...
<html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Faculdade Anasps - Cursos de capacitação</title>
        ...
        <div id="home-page">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="../assets/img/livres/banners/01banner_preparado.jpg" alt="">
                </div>

                <div class="item">
                     <img src="../assets/img/livres/banners/02banner_100.jpg" alt="">
                </div>

                <div class="item">
                     <img src="../assets/img/livres/banners/03banner_enriquecer.jpg" alt="">
                </div>
            </div>
           ...
           <!-- end Banner Slide -->
            ...
            <div class="main-content">
                <section class="bg-light-white skill">
                    <div class="container">
                        <br>
                        <div class="row">
                            <div class="col-md-6">
                                <h2>CONHEÇA OS CURSOS DE CAPACITAÇÃO</h2>
                                <p align="justify">
                                    Neste espaço estarão disponíveis aulas direcionadas ao público que tem interesse em adquirir conhecimento nas mais diversas áreas, dentre elas direito, previdência, saúde e assistência social. Temas de relevância nacional e interesse público serão trazidos de maneira didática, a fim de aprofundar o debate na esfera acadêmica. 
                                <p align="justify">Além de oferecer aos discentes uma formação acadêmico-profissional que viabilize a produção, a apropriação e a socialização do conhecimento, para que possam compreender o contexto da gestão pública e da previdência e, assim, possam intervir de forma ativa nos processos institucionais e sociais, de forma integrada e sustentável
                                </p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/GgAdOcFkOX0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
								...
								<div class="col-md-4 col-sm-6">
                                    <div class="portfolio-item">
                                        ...
                                        <div class="item-description">
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <h5>Introdução ao Sistema Constitucional Tributário</h5>
                                                </div>
                                            </div>
                                        </div> <!-- end of /.item-description -->
                                    </div> <!-- end of /.portfolio-item -->
